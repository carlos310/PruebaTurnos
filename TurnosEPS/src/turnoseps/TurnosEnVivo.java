 ...
 * @author charl
 */
public class TurnosEnVivo extends javax.swing.JFrame {

    /**
     * Creates new form TurnosEnVivo
     */
    List <String> nombres= new LinkedList<>();
    List <String> cedulas= new LinkedList<>();
    List <String> caja= new LinkedList<>();
    public TurnosEnVivo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Pase a la caja indicada abajo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TurnosEnVivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TurnosEnVivo().setVisible(true);
            }
        });
    }
